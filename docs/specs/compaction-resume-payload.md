...
- `COMPACTION_RESUME_PREAMBLE` — constant framing paragraph ("Your session just went through context compaction — your working memory was reset. The context below is what you had before the reset. Briefly let the user know compaction occurred, then continue the conversation naturally.")
