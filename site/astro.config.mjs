      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Slack Integration', slug: 'features/slack' },
            ...
            { label: 'Coherence Gate', slug: 'features/coherence-gate' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'The Living System', slug: 'architecture/the-living-system' },
          ],
        },
        {
          label: 'Reference',
