...
import type { ThreadlineClient, KnownAgent, ReceivedMessage } from '../client/ThreadlineClient.js';
 ...
 */
export function createCrewAITools(client: ThreadlineClient): CrewAIToolDefinition[] {
  return [
    {
    ...
    },
    {
      ...
      description:
        'Send a message to another agent on the Threadline relay. ' +
    ...
    },
    {
      ...
      description:
        'List all known agents (previously discovered). ' +
        'Input: ignored. ' +
    ...
    },
    {
      ...
      description:
        'Get the current Threadline connection status. ' +
        'Input: ignored. ' +
