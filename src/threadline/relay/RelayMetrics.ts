...
export class RelayMetrics {
  ...
  // Counters
  private _messagesRouted = 0;
  private _messagesDelivered = 0;
  private _messagesQueued = 0;
  private _messagesRejected = 0;
  private _messagesExpired = 0;
  private _connectionsTotal = 0;
  private _authFailures = 0;
  private _abuseBansIssued = 0;
  private _discoveryQueries = 0;
  private _a2aRequestsTotal = 0;
  private _a2aRequestsRejected = 0;

  // Gauge (set externally)
  private _connectionsActive = 0;
