/**
 * LiveOutputStream: tmux capture-pane snapshot + tail.
 */
...
class AnthropicHeadlessLiveOutputStream implements LiveOutputStream {
...
export function createLiveOutputStream(config: AnthropicHeadlessConfig): LiveOutputStream {
  return new AnthropicHeadlessLiveOutputStream(config);
}
